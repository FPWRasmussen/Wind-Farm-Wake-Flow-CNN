...
#         self.decode2 = nn.Conv2d(64, 64, 3, 1, 1)
#         self.decode3 = nn.Conv2d(64, 32, 3, 1, 1)
#         self.decode4 = nn.Conv2d(32, 32, 3, 1, 1)
#         self.decode5 = nn.Conv2d(32, 16, 5, 1, 2)
#         self.decode6 = nn.Conv2d(16, 16, 5, 2, 2)
#         self.decode7 = nn.Conv2d(16, 8, 5, 1, 2)
#         self.decode8 = nn.Conv2d(8, 8, 5, 2, 2)
#         self.decode9 = nn.Conv2d(8, 4, 5, 1, 2)
#         self.decode10 = nn.Conv2d(4, 4, 5, 2, 2)
#         self.decode11 = nn.Conv2d(4, out_channels, 5, 1, 2)
#         # Dropout
#         self.dropout = nn.Dropout(0.3)
#     def forward(self, x, extra_vars):
#     # Encoder
...
if __name__ == "__main__":
    ...
    model = CAE3(in_channels=num_channels, out_channels=num_classes, num_extra_features=num_extra_features)
